  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      {{-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8"> --}}
      <span class="brand-text font-weight-light" style="margin-left: 70px;">Vape Turf</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/orders" class="nav-link {{ 'orders' == request()->path() ? 'active' : '' }}">
            <i class="fa-fw fas fa-list nav-icon"></i>
              <p>Orders</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="/expenses" class="nav-link {{ 'expenses' == request()->path() ? 'active' : '' }}">
            <i class="fa-fw fas fa-arrow-circle-right nav-icon"></i>
              <p>Expenses</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="/posts" class="nav-link {{ 'posts' == request()->path() ? 'active' : '' }}">
            <i class="fa-fw fas fa-arrow-circle-right nav-icon"></i>
              <p>Blogs</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="/inqueries" class="nav-link {{ 'inqueries' == request()->path() ? 'active' : '' }}">
            <i class="fa-fw fas fa-arrow-circle-right nav-icon"></i>
              <p>Inqueries</p>
            </a>
          </li>
